...
export const patterns: PatternEntry[] = [
  ...
  { id: 'sx-tious', category: 'suffix', grapheme: 'tious', phoneme: '/ʃəs/', examples: ['cautious', 'ambitious', 'conscientious', 'infectious'], hint: '"-tious" says "shus".' },
  { id: 'sx-cious', category: 'suffix', grapheme: 'cious', phoneme: '/ʃəs/', examples: ['precious', 'delicious', 'spacious', 'gracious'], hint: '"-cious" says "shus".' },
  { id: 'sx-tient', category: 'suffix', grapheme: 'tient', phoneme: '/ʃənt/', examples: ['patient', 'impatient', 'quotient'], hint: '"-tient" says "shunt".' },
  { id: 'sx-cient', category: 'suffix', grapheme: 'cient', phoneme: '/ʃənt/', examples: ['ancient', 'efficient', 'sufficient', 'proficient'], hint: '"-cient" says "shunt".' },
  { id: 'sx-ience', category: 'suffix', grapheme: 'ience', phoneme: '/iəns/', examples: ['experience', 'audience', 'convenience', 'obedience'], hint: '"-ience" says "ee-unce".' },
  ...
  { id: 'ir-sci-sh', category: 'irregular', grapheme: 'sci', phoneme: '/ʃ/', examples: ['conscious', 'conscience', 'luscious', 'omniscient'], hint: '"sci" can say "sh" in some words.' },
